      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-end">
          <div>
            ...
            <h2 className="text-[34px] font-bold leading-tight sm:text-[46px]">
              More than icons: skills I use to ship AI products.
            </h2>
            <p className="mt-5 text-lg leading-8 text-gray-300">
              My stack combines frontend engineering, backend APIs, Voice AI
              infrastructure, agentic workflows, cloud deployment, and
              AI-readable SEO.
            </p>
          </div>
        ...
        <div className="mt-12 grid gap-5 md:grid-cols-2 xl:grid-cols-4">
          {featuredGroups.map((group) => (
            <article
              key={group.title}
              className="rounded-lg border border-white/10 bg-[#0c0e23]/70 p-6 backdrop-blur-xl transition hover:-translate-y-1 hover:border-emerald-300/50"
            >
        ...
        <div className="mt-10 rounded-lg border border-white/10 bg-[#0c0e23]/60 p-5">
