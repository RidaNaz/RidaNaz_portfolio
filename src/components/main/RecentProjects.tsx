    ...
    <main id="portfolio" className="-mt-48">
      <div className="pt-12">
        <h1 className="text-center text-[40px] font-bold text-white">
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-800 to-pink-600">Agentic AI Projects</span>
        </h1>
        <div className="flex flex-wrap items-center justify-center p-4 gap-16 mt-10">
          {agentic_projects.map((item) => (
            <div
      ...
      <div className="pt-12">
        <h1 className="text-center text-[40px] font-bold text-white">
          A small selection of{" "}
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-800 to-pink-600">Custom GPTs</span>
        </h1>
        <div className="flex flex-wrap items-center justify-center p-4 gap-16">
          {generating_ai_projects.map((item) => (
            <div
              className="lg:min-h-[32.5rem] h-[25rem] flex items-center justify-center sm:w-96 w-[80vw]"
              key={item.id}
            >
